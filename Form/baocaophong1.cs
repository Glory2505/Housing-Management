...
namespace BTL_Form {
    ...
    public class baocaophong1 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "BTL_Form.baocaophong1.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedbaocaophong1 : Component, ICachedReport {
        
        public Cachedbaocaophong1() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            baocaophong1 rpt = new baocaophong1();
            rpt.Site = this.Site;
            return rpt;
        }
