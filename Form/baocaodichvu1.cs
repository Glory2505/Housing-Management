...
namespace BTL_Form {
    ...
    public class baocaodichvu1 : ReportClass {
        
        public baocaodichvu1() {
        }
        
        public override string ResourceName {
            get {
                return "baocaodichvu1.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "BTL_Form.baocaodichvu1.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedbaocaodichvu1 : Component, ICachedReport {
        
        public Cachedbaocaodichvu1() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            baocaodichvu1 rpt = new baocaodichvu1();
            rpt.Site = this.Site;
            return rpt;
        }
